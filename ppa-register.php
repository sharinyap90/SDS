                                    ...
                                    <div class="tab-pane fade in active" id="personalparticular">
										<form id="personalparticular" method="post" class="form-horizontal" >
											<div class="login-header margin-bottom-30">
												<center><h2>Student University Enrolment Confirmation</h2>
											</div>
											<hr>
											...
											<div class="form-group">
											 <label class="col-sm-3 control-label">Programme Taken</label>
											 <div class="col-sm-7">
											...
											<div class="form-group">
											 <label class="col-sm-3 control-label">Programme Status</label>
											 <div class="col-sm-7">
											<label class="radio-inline col-sm-2">
												<input type="radio" name="programmeStatus" value="Confirmed" required data-parsley-required="true">Confirmed
											</label>
											<label class="radio-inline">
												<input type="radio" name="programmeStatus" value="Changed" >Changed
											</label>
											 </div>
											</div>
											...
											<div class="form-group">
											 <label class="col-sm-3 control-label">Document Verified</label>
											 <div class="col-sm-7">
											<input type="text" class="form-control" name="verification" readonly />
											 </div>
											</div>
											
											<div class="form-group">
											 <label class="col-sm-3 control-label">Document Complete Status</label>
											 <div class="col-sm-7">
											<input type="text" class="form-control" name="complete" readonly />
											 </div>
											</div>
											
											<div class="form-group">
											 <label class="col-sm-3 control-label">Enrollemt Status</label>
											 <div class="col-sm-7">
											<label class="radio-inline col-sm-2">
												<input type="radio" name="enrol" value="Registered" required data-parsley-required="true">Registered
											</label>
											<label class="radio-inline">
												<input type="radio" name="enrol" value="Withdrawed" >Withdrawed
											</label>
											 </div>
											</div>
