                    ...
                    <div class="container">
                        <div class="row margin-vert-30">
                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                                <form class="login-page" name="studentLogin" action = "loginStudentValidate.php" method = 'POST'>
                                    <div class="login-header margin-bottom-30">
                                        <h2>New Student 2016/2017 Intake</h2>
                                    </div>
                                    <div class="input-group margin-bottom-20">
                                        <span class="input-group-addon">
                                            <i class="fa fa-user"></i>
                                        </span>
                                        <input placeholder="Your Matric No." class="form-control" type="text" name="matric">
                                    </div>
                                    <div class="input-group margin-bottom-20">
                                        <span class="input-group-addon">
                                            <i class="fa fa-lock"></i>
                                        </span>
                                        <input placeholder="Your IC No." class="form-control" type="password" name="ic" >
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
