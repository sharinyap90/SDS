                        ...
                        <div class="col-md-12 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
									...
									<li>
                                        <a href="#" class="fa-home active">Update Profile</a>
                                    </li>   
                                </ul>
                                    ...
                                    <div class="tab-pane fade in active" id="personalparticular">
										<form id="personalparticular" method="post" class="form-horizontal" >
											...
											<div class="form-group">
											 ...
											 <div class="col-sm-7">
											<label class="radio-inline col-sm-2">
												<input id="oku_yes" type="radio" name="oku" required data-parsley-required="true" onChange="findselected()">Yes
											</label>
											<label class="radio-inline">
												<input id="oku_no" type="radio" name="oku" checked="checked" onChange="findselected()">No
											</label>
											 </div>
											</div>
											...
											<div class="form-group">
											 ...
											 <div class="col-sm-3">
											 <input id="inputtext" type="text" class="form-control" required data-parsley-pattern="^[a-zA-Z ]+$" placeholder="none"/>
											 </div>
											</div>
											...
											<div class="form-group">
											 ...
											 <div class="col-sm-3">
											 <input type="text" class="form-control" required data-parsley-type="number" placeholder=""  />
											 </div>
											</div>
											...
											<div class="form-group">
											 ...
											 <div class="col-sm-7">
											<label class="radio-inline col-sm-2">
												<input id="oku_yes" type="radio" name="colorBlind" required data-parsley-required="true" onChange="findselected()">Yes
											</label>
											<label class="radio-inline">
												<input id="oku_no" type="radio" name="colorBlind" onChange="findselected()">No
											</label>
											 </div>
											</div>
