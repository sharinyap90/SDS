                        ...
                        <div class="col-md-12 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
									<li>
                                        <a href="studentRegister.php" class="fa-home active">Student Financial Profile</a>
                                    </li>
                                    ...
                                    <div class="tab-pane fade in active" id="personalparticular">
										<form id="personalparticular" method="post" class="form-horizontal" >
											...
											<label class="radio-inline col-sm-3">
												<input type="radio" name="bursaryStatus" required data-parsley-required="true">Paid in Full
											</label>
											<label class="radio-inline">
												<input type="radio" name="bursaryStatus">Out-standing Fees
											</label>
											 </div>
											</div>
