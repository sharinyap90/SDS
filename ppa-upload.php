            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
							...
							<center><h1 style="margin-bottom:15px;">Document Upload List</h1></center>
								<hr>
								...
								<div class="col-md-0 col-md-offset-0 col-sm-offset-0">
									...
									<form id="" method="post" class="form-horizontal">
													...
													<div class="table-responsive">
														<table id="" class="table table-striped table-bordered table-hover">
															...
															<tbody>
																<tr>
																	<td scope="col">1</td>
																	<td scope="col">Birth Certificate.pdf</td>
																	<td scope="col"></td>
																	<td scope="col"><a href="#">path name</a></td>
																</tr>
																<tr>
																	<td scope="col">2</td>
																	<td scope="col">Identity Card.pdf</td>
																	<td scope="col"></td>
																	<td scope="col"><a href="#">path name</a></td>
																</tr>
																<tr>
																	<td scope="col">3</td>
																	<td scope="col">SPM Cert</td>
																	<td scope="col"></td>
																	<td scope="col"><a href="#">path name</a></td>
																</tr>
															</tbody>
											...
											<div class="form-group">
											 <label class="col-sm-3 control-label">Document Complete</label>
											 <div class="col-sm-7">
											<label class="radio-inline col-sm-2">
												<input type="radio" name="complete" value="Completed" required data-parsley-required="true">Completed
											</label>
											<label class="radio-inline">
												<input type="radio" name="complete" value="Not Completed" >Not Completed
											</label>
											 </div>
											</div>
											
											<div class="form-group">
											 <label class="col-sm-3 control-label">Document Verify</label>
											 <div class="col-sm-7">
											<label class="radio-inline col-sm-2">
												<input type="radio" name="verify" value="Verified" required data-parsley-required="true">Verified
											</label>
											<label class="radio-inline">
												<input type="radio" name="verify" value="Not Verified" >Not Verified
											</label>
											 </div>
											</div>
